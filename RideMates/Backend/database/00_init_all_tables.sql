...
CREATE TABLE rides (
    ...
    base_price          DECIMAL(8, 2) NOT NULL           COMMENT 'System-calculated raw fuel cost',
    driver_set_price    DECIMAL(8, 2) NOT NULL           COMMENT 'Price the driver wants to charge (before capping)',
    capped_price        DECIMAL(8, 2) NOT NULL           COMMENT 'Final price = MIN(driver_set_price, vehicle-specific max cap)',
