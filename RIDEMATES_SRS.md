...
| 1.6 | April 1, 2026 | Project Team | LocationIQ API integration for location search across entire Punjab region; UI/UX improvements (rounded button styling, proper state management for ride details); backend security fix (express-rate-limit trust proxy configuration for secure Render deployment); app branding finalized (name: RideMates, package: com.ridemates.app); Render deployment complete with proper environment variables |
| 1.6 | April 1, 2026 | Project Team | LocationIQ API integration for location search across entire Punjab region; UI/UX improvements (rounded button styling, proper state management for ride details); backend security fix (express-rate-limit trust proxy configuration for secure Render deployment); app branding finalized (name: RideMates, package: com.ridemates.app) |
